...
# Base data directory
DATA_DIR = Path(r"L:/dmclab/Joana/PFC-Str_behavior_project/Behavior/Cohort_2")
ANALYSIS_FOLDER_NAME = "Analysis"

# Map protocol prefix to script
protocol_to_script = {
    'FreeLick': 'analyze_free_licking.py',
    "2ChoiceBlocks": 'analyze_2choice_auditory_blocks.py',
    ...
    for animal_dir in DATA_DIR.iterdir():
        ...
        for date_dir in behavior_dir.iterdir():
            ...
            for file in data_files:
                ...
                if not match:
                    print(f"⚠️  Regex didn't match: {file.name}") #new
                    continue
